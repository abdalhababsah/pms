...
@section('content')
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <button class="btn btn-info float-end" type="button" data-bs-toggle="offcanvas"
                        data-bs-target="#employeeAssignCanvas" aria-controls="employeeAssignCanvas">
                        Assign Team Members
                    </button>
                </div>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="employeeAssignCanvas"
        aria-labelledby="employeeAssignCanvasLabel">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            searchInput.addEventListener('input', function() {
                ...
                timeout = setTimeout(function() {
                    ...
                    if (query.length > 0) {
                        fetch("{{ route('team.employees.search') }}?q=" + encodeURIComponent(
                                query) + "&team_leader_id={{ $teamLeader->id }}")
                    ...
                    button.addEventListener('click', function() {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                fetch("{{ route('team.teamMember.remove', '') }}/" +
                                        assignmentId, {
                                            method: 'DELETE',
                                            headers: {
                                                'Content-Type': 'application/json',
